...
<div id='main-table-box'>
	...
	<div class='form-div' style="background:#F7F7F7;">
		<?php
		$counter = 0; 
...
<div style="clear:both"></div>		
	...
	<div class="pDiv">
		<div class='form-button-box'>
			<input type='submit' value='<?php echo $this->l('form_update_changes'); ?>' class="btn btn-large btn-success"/>
		</div>
<?php 	if(!$this->unset_back_to_list) { ?>			
		...
		<div class='form-button-box'>
			<input type='button' value='<?php echo $this->l('form_cancel'); ?>' onclick='javascript: return goToList()' class="btn btn-large btn-danger" />
		</div>
<?php 	} ?>				
		<div class='form-button-box'>
