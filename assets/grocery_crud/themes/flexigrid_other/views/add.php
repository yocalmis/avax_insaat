...
<div style="clear:both"></div>
		...
		<div class="pDiv">
			<div class='form-button-box'>
				<input type='submit' value='<?php echo $this->l('form_save'); ?>'  class="btn btn-large btn-success"/>
			</div>
<?php 	if(!$this->unset_back_to_list) { ?>				
			...
			<div class='form-button-box'>
				<input type='button' value='<?php echo $this->l('form_cancel'); ?>' onclick="javascript: goToList()"  class="btn btn-large btn-danger" />
			</div>
<?php 	} ?>						
			<div class='form-button-box'>
