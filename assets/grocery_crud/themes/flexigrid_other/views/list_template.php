...
<div class="flexigrid" style='width: 100%;'>
	...
	<div class="tDiv">
		...
		<div class="tDiv3">
			...
			<?php }?>	
	          <div class="fbutton  quickSearchButton" >
					<span id='quickSearchButton' class="find"><?php echo $this->l('list_search');?></span>
			  </div>
	...
	<?php echo form_open( $ajax_list_url, 'method="post" id="filtering_form" class="filtering_form" autocomplete = "off"'); ?>	
		<div class="sDiv quickSearchBox form-div" id='quickSearchBox'>
		<div class="sDiv2">
            ...
            <input type="button" value="<?php echo $this->l('list_search');?>" class="crud_search btn btn-large btn-success" id='crud_search'> 
		</div>
        <div class='search-div-clear-button'>
        	<input type="button" value="<?php echo $this->l('list_clear_filtering');?>" id='search_clear' class="btn btn-large btn-primary">
        </div>
	</div>
