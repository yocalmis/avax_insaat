...
<body>
    ...
    <div id="body-wrap">
       ...
       <?php if( $p_r ) :  foreach( $p_r  as $dizi ) : ?>	
          ...
          <?php if($dizi['id']==1){$rs=$dizi['resim']; } endforeach;  endif; ?>  
        ...
        <section id="page-content">
            ...
            <div class="page-title_son text-center position-relative bg-cover" style="background-image: url(<?php echo base_url(); ?>assets/uploads/files/<?php echo $rs; ?>);">
                ...
                <div class="page-content position-relative">
                    <h2 class="color-white font-700">Katalog</h2>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                        <div class="heading text-center yukselt">
                				<br><h3><b><center>2023 KATALOG</center></b></h3><br><br>
		...
		/*.yukseklik__Dengele{
			...
			grid-template-columns: auto auto auto;
                ...
                <div class="row">
                  ...
                  <center>
               <!--  <a href="<?php echo base_url(); ?>assets_user/images/cata.pdf"> <img class="img-responsive" src="<?php echo base_url(); ?>assets_user/images/cata.jpg" style="width:200px; height:400px;" alt="Avax">
                    </a>  -->
         

          <!-- 	<iframe allowfullscreen="" scrolling="no" class="fp-iframe" style="border: 1px solid lightgray; width: 80%; height: 400px;" src="https://heyzine.com/flip-book/d8cd8b5b27.html"></iframe>	   
-->
                    <a href="<?php echo base_url(); ?>FlipBook/index.html">Oku</a>
