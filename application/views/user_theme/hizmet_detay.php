...
<meta name="keywords" content="<?php echo strip_tags($dizi['seo_keywords']); ?>">
	...
	<?php if( $hizmet_detay ) :  foreach( $hizmet_detay  as $dizi ) : ?>	
<body>
    <!--Start Preloader
    <div class="preloader">
        <div class="spinner">
...
<?php if( $p_r ) :  foreach( $p_r  as $dizi2 ) : ?>	
          
          <?php if($dizi['id']==1){$rs=$dizi2['resim']; } endforeach;  endif; ?>  
                    ...
                    <div class="breadcrumb">
                        <ul>
                            ...
                            <li class="active">Hizmetlerimiz</li>
                              <li>/</li>
                            <li class="active">  <?php echo $dizi['baslik']; ?>    </li>                          
...
<section id="about">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="about-img">
 	   <img src="<?php echo base_url(); ?>assets/uploads/files/<?php echo $dizi['resim']; ?>" style="width:80%;" class="img-responsive" alt="Image">                      
                    ...
                    <h2 class="font-700"><?php echo $dizi['baslik']; ?></h2>
											
                       <?php echo $dizi['yazi']; ?>   </div>	
