        ...
        <section id="page-content">
            ...
            <div class="page-title_son text-center position-relative bg-cover" style="background-image: url(<?php echo base_url(); ?>assets/uploads/files/<?php echo $rs; ?>);">
                ...
                <div class="page-content position-relative">
                    <h2 class="color-white font-700">Hizmetlerimiz</h2>
...
<section id="services" class="bg-gray default-padding">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                        <div class="heading text-center yukselt">
                				<br><h3><b><center>HİZMETLERİMİZ</center></b></h3><br><br>
	...
	<style>
		...
		<?php if( $hizmet ) :  foreach( $hizmet  as $dizi ) : ?>		
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="service-single text-center">
                           <i class="icofont <?php echo $dizi['icon']; ?>"></i>
                            <a href="<?php echo base_url(); ?>hizmetlerimiz/detay/<?php echo $dizi['seo_name']; ?>">        <h4 class="font-600">
                       <?php echo $dizi['baslik']; ?></h4></a>
...
<?php echo $dizi['hizmetlerimiz_yazi']; ?>
