...
<!-- Swiper -->
  <div class="swiper-container">
    <div class="swiper-wrapper" style="justify-content: center;">
	 ...
	 <a href="<?php echo base_url(); ?>haber/detay/<?php echo $dizi['seo_name']; ?>"> <img class="rad" style="width:220px; height:200px;" src="<?php echo base_url(); ?>assets/uploads/files/<?php echo $dizi['img']; ?>"> </div>
