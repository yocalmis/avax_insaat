...
<body>
    ...
    <div id="body-wrap">
        ...
        <section id="page-content">
          ...
          <?php if($dizi['id']==6){$rs=$dizi['resim']; } endforeach;  endif; ?>  
            ...
            <div class="page-title_son text-center position-relative bg-cover" style="background-image: url(<?php echo base_url(); ?>assets/uploads/files/<?php echo $rs; ?>);">
                ...
                <div class="page-content position-relative">
                    <h2 class="color-white font-700">Sektörel Haberler</h2>
                    <div class="breadcrumb">
                        <ul>
                            <li><a href="<?php echo base_url(); ?>">Anasayfa</a></li>
                            <li>/</li>
                            <li class="">Sektörel Haberler</li>
                        </ul>
                    </div>
                </div>
            </div>
...
<body>
				...
				<br><h3><b><center>Sektörel Haberler</center></b></h3><br><br>

					<?php if( $sektor ) :  foreach( $sektor  as $dizi ) : ?>		
...
<div class="col-md-10">
<a href="<?php echo base_url(); ?>sektor/detay/<?php echo $dizi['seo_name']; ?>">
<?php echo $dizi['header']; ?></div>
<div class="col-md-2"><?php echo $dizi['date']; ?>
</a>
</div>
</button>
<div class="panel">
<div class="col-md-3">
<a href="<?php echo base_url(); ?>sektor/detay/<?php echo $dizi['seo_name']; ?>">
<img style="margin:20px; width:200px; height:200px; max-width:200px; border-radius:20%;" src="<?php echo base_url(); ?>assets/uploads/files/<?php echo $dizi['img']; ?>">
</a>
 </div>

<div class="col-md-9">
<a href="<?php echo base_url(); ?>sektor/detay/<?php echo $dizi['seo_name']; ?>">
<h2><?php echo $dizi['manset']; ?></h2>
detaylı okuyun</a>
</div>
