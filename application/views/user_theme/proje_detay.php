...
<body>
    ...
    <div id="body-wrap">
        ...
        <section id="page-content">
            <!--Start Page Title-->	<?php if( $proje_detay ) :  foreach( $proje_detay  as $dizi ) : ?>		 

            <div class="page-title_son text-center position-relative bg-cover"  style="background-image: url(<?php echo base_url(); ?>assets/uploads/files/<?php echo $dizi['proje_detay_ust_resim']; ?>);">
                   <?php  endforeach;  endif; ?>               
              <div class="overlay"></div>
                <div class="page-content position-relative">
                    <h2 class="color-white font-700">Proje Detay</h2>
                    <div class="breadcrumb">
                        <ul>
                            <li><a href="<?php echo base_url(); ?>">Anasayfa</a></li>
                            <li>/</li>
                            <li class="active">Proje Detay</li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="container gallery-container" style="min-height:auto">
    
    <div class="tz-gallery">

        <div class="row">
		
						<?php if( $proje_detay ) :  foreach( $proje_detay  as $dizi2 ) : ?>		 
					 
			 
			 <h1 ><?php echo $dizi2['baslik']; ?></h1>	
			 <h2  ><?php echo $dizi2['manset']; ?></h2>			 
			 <br><br> <h3><b><center>PROJE DETAYLARI</center></b></h3>
			 			 <h1><?php echo $dizi2['yazi']; ?></h1>
          ...
          <?php endforeach;  endif; ?>  
		 <br><br>
		 <h3><b><center>PROJE GALERİSİ</center></b></h3><br><br>
		
						<?php if( $resim ) :  foreach( $resim  as $dizi ) : ?>	
         
            <div class="col-sm-1 col-md-1">
                <a class="lightbox" href="<?php echo base_url(); ?>assets/uploads/files/<?php echo $dizi['rsm']; ?>">
                    <img style="width:80px; height:50px;" src="<?php echo base_url(); ?>assets/uploads/files/<?php echo $dizi['rsm']; ?>" alt="Park">
                </a><b></b> 
            </div>
...
<div class="row">
				...
				<?php if( $dizi2['video_link']!="" ) {?> 
	<br><br> <h3><b><center>PROJE VİDEOLARI</center></b></h3><br><br>	
		
		
<div class="col-md-6">

<iframe width="100%" height="400px" src="<?php echo $dizi2['video_link']; ?>" title="" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>	

</div>		
	
<div class="col-md-6">
<iframe width="100%" height="400px" src="<?php echo $dizi2['video_link_2']; ?>" title="AFRO mu TÜRK! Farkında mısın?" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>			
	</div>			
					<?php } ?>	
          <?php endforeach;  endif; ?>  
...
<div class="row">
				...
				<?php if( $dizi2['lokasyon']!="" ) 					{?> 


					<br><br> <h3><b><center>PROJE KONUMU</center></b></h3><br><br>	
					
							
				

			 			 <h1><?php echo $dizi2['lokasyon']; ?></h1>
