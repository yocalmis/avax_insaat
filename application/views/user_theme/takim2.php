        ...
        <section id="page-content">
            ...
            <div class="page-title_5 text-center position-relative bg-cover">
                ...
                <div class="page-content position-relative">
                    <h2 class="color-white font-700">Ekip Arkadaşlarımız</h2>
                    <div class="breadcrumb">
                        <ul>
                            <li><a href="<?php echo base_url(); ?>">Anasayfa</a></li>
                            <li>/</li>
                            <li class="active">Ekip Arkadaşlarımız</li>
                        </ul>
                    </div>
                </div>
            </div>
         ...
         <section id="team" class="default-padding">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                        <div class="heading text-center">
                            <h2 class="font-700"><span class="color-base"></span> Ekip Arkadaşlarımız </h2>
                       </div>
                    </div>
                </div>
				...
				<?php if( $takim ) :  foreach( $takim  as $dizi ) : ?>	
                    ...
                    <div style="padding-bottom:100px;" class="col-md-3 col-sm-6">
                        <div class="team-member-single fix position-relative text-center">
							
						<?php if($dizi['img_name']==""){ 	?>	
						<img style="width:100%; height:250px;" src="<?php echo base_url(); ?>assets/images/team-1.jpg" class="img-responsive" alt="Image">
						<?php } else { 	?>	
						<img style="width:100%; height:250px;" src="<?php echo base_url(); ?>assets/uploads/files/<?php echo $dizi['img_name']; ?> " class="img-responsive" alt="Image">
						<?php }	?>			
                            ...
                            <div class="member-social">
                               ...
                               <?php if($dizi['facebook']!=""){ ?> <li><a href="<?php echo $dizi['facebook']; ?>"><i class="icofont icofont-social-facebook"></i></a></li><?php } ?> 
                               <?php if($dizi['facebook']!=""){ ?> <li><a href="<?php echo $dizi['twitter']; ?>"><i class="icofont icofont-social-twitter"></i></a></li><?php } ?> 
                               <?php if($dizi['facebook']!=""){ ?> <li><a href="<?php echo $dizi['instagram']; ?>"><i class="icofont icofont-social-instagram"></i></a></li><?php } ?> 
                            ...
                            <div class="member-details position-relative" style="background-color:#a3d4ff;">
                                ...
                                <p class="color-white"><?php echo $dizi['pozisyon']; ?><br>
							<?php echo $dizi['telefon']; ?> <br>

								<?php echo $dizi['email']; ?> </p>
                            </div>
                        </div>
                    </div>
